...
The idea here is to try to effectively have an "Ising model" which is a model in statistical physics ([https://www.youtube.com/watch?v=1CCZkHPrhzk](https://www.youtube.com/watch?v=1CCZkHPrhzk))
...
**neoTRNG** — three inverter rings (5, 7, 9 inverters) with XOR combining - Thermal jitter should provide the true entropy. [BSD 3-Clause licensed - ported from VHDL](https://github.com/stnolting/neoTRNG).
